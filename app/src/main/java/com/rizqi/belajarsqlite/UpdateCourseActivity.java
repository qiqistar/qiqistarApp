package com.rizqi.belajarsqlite;
...
public class UpdateCourseActivity extends AppCompatActivity {
    ...
    private Button updateCourseBtn, deleteCoursesBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deleteCoursesBtn = findViewById(R.id.idBtnDelete);
        ...
        deleteCoursesBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
